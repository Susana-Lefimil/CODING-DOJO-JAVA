...
<body>
	<div class="container">
		<div class="row">
			<div class="col-md-12">
				<h2 class="p-3 mb-2 text-success">Add an appointment</h2>
					<legend>Add an appointment</legend>
			

				<form:form method="POST" action="/appointments/add"
					modelAttribute="cita">
				...
				<a href="/appointments" class="btn btn-secondary">List Appoinments</a>
			</div>
		</div>
	</div>
